...
export default function Contacto() {
  ...
  return (
    <>
      <div
        className="relative bg-cover flex flex-col md:bg-top bg-center md:h-[2000px] h-svh overflow-scroll scrollbar-hide text-center items-center"
      ...
      >
        ...
        >
          <textarea
            ...
            className="text-gray-900 text-2xl md:w-2/3 w-full p-8 mt-16 rounded-2xl"
          />
          <button
            type="submit"
            className="bg-green-700 py-4 px-6 mt-4 rounded-xl text-xl hover:bg-green-800"
          >
            Enviar consulta
          </button>
        </form>
